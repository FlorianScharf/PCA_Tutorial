...
# This script conducts the initial estimation of the unrotated temporal EFA model.
...
# delete all variable except for the sampling points (necessary for the EFA functions)
...
# which shall enter the EFA. Please make sure to remove any indicator variables
...
efaFit = fa_simplified(r = age_group_data, nfactors = nFac, rotate = "none", covar = TRUE)
...
efaFit$S = S # Sample Covariance Matrix
efaFit$Sinv = Sinv # (Moore-Penrose) Inverse of the Sample Covariance Matrix
efaFit$R = R # Sample Correlation Matrox
efaFit$Rinv = Rinv # (Moore-Penrose) Inverse of the Sample Covariance Matrix
efaFit$varSD = varSD # SDs of the Sampling Points
efaFit$Var = Var # Variances of the Sampling Points
efaFit$group = group
...
save(efaFit, file = paste0("results/02ab_efa/efafit_", group, nFac, ".Rdata"))
###############